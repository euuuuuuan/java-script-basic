...
// let myDate = new Date(1000); // 해당 시간에서 1초가 지난 날짜 갱신

// new Date('YYYY-MM-DD')
let myDate1 = new Date('2024-05-24');

// new Date('YYYY-MM-DDThh:mm:ss')
let myDate2 = new Date('2024-05-24T19:11:16');

console.log(myDate1);
console.log(myDate2);

// new Date(year, month, date, hours, minutes, seconds, ms)
let myDate3 = new Date(2024, 4, 18, 19, 11, 16);

// 월까지만 입력하고 뒤의 정보는 생략 가능하다.
// 주의사항: month는 컴퓨터 언어로 0부터 시작한다.
...
// myDate객체가 0000년 0월 0일 00:00:00 UTC부터 몇 밀리초가 지났는지. -> 타임 스탬프(time stamp)

// getFullYear, getMonth, getDate, getDay, getHours, getMinutes, getSeconds, getMilliseconds가 있다.
// Date는 일자를 의미하고, day는 요일을 의미한다. (일요일부터 0 ~ 6까지) ex: day가 4이면 목요일이라는 뜻.

console.log('Date 객체 정보 수정');
...
console.log(myDate6.toLocaleDateString()); // myDate가 가진 날짜에 대한 정보 (년. 월. 일)
console.log(myDate6.toLocaleTimeString()); // myDate가 가진 시간에 대한 정보 (시:분:초)
console.log(myDate6.toLocaleString()); // myDate가 가진 날짜와 시간에 대한 정보 (년. 월. 일 시:분:초)
...
하지만 이런 방식을 사용하다보면 브라우저나, 컴퓨터를 사용하는 위치의 시간대에 따라 서로 다른 결과 값이 나올 수도 있기 때문에
*  적어도 IETF 호환 RFC 2822 타임스탬프와 ISO8601의 한 버전의 형식을 준수하는 문자열로 Date객체를 생성하는 것을 권장드립니다!
* */